...
function _Layout:draw()
	...
	local x1, w1 = gfx_util.layout(gx[2], gw[2], { -0.5, 480, 20, 600, -0.5 })
	local y1, h1 = gfx_util.layout(gy[2], gh[2], { 200, -1, 200 })

	self:pack("modalName", gx[2], y1[1], gw[2], h1[1])
	self:pack("noteSkins", x1[2], y1[2], w1[2], h1[2])
	self:pack("noteSkinSettings", x1[4], y1[2], w1[4], h1[2])
	self:pack("selectedNoteSkin", gx[2], y1[3], gw[2], h1[3])
end
