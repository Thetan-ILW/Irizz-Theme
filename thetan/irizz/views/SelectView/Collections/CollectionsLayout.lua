...
local outerPanelsSize = Theme.layout.collectionsOuterPanelsSize
local innerPanelSize = Theme.layout.collectionInnerPanelSize
local gap = Theme.layout.gap
local verticalPanelGap = Theme.layout.collectionsVerticalPanelGap
local horizontalPanelGap = Theme.layout.horizontalPanelGap
local buttonsPanelScale = Theme.layout.collectionsButtonsPanelScale
